        ...
        <CardContent className="pt-6 pb-6 px-6">
          <form onSubmit={(e) => void handleSubmit(e)} className="space-y-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label htmlFor="camp-title" className="text-sm font-semibold text-secondary mb-1 block">Campaign title *</label>
                <Input id="camp-title" value={form.title} onChange={set("title")} placeholder="e.g. Sales Hiring Q3 2025" required />
              </div>
              <div>
                <label htmlFor="camp-role" className="text-sm font-semibold text-secondary mb-1 block">Role / Position *</label>
                <Input id="camp-role" value={form.role} onChange={set("role")} placeholder="e.g. Sales Executive" required />
              </div>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label htmlFor="camp-exp" className="text-sm font-semibold text-secondary mb-1 block">Experience level</label>
                <select id="camp-exp" value={form.experienceLevel} onChange={set("experienceLevel")}
              ...
              <div>
                <label htmlFor="camp-type" className="text-sm font-semibold text-secondary mb-1 block">Interview type</label>
                <select id="camp-type" value={form.interviewType} onChange={set("interviewType")}
                  className="w-full border border-border rounded-md px-3 py-2 text-sm bg-background text-secondary focus:outline-none focus:ring-2 focus:ring-primary">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label htmlFor="camp-coach" className="text-sm font-semibold text-secondary mb-1 block">AI Interviewer</label>
                <select id="camp-coach" value={form.coachId} onChange={set("coachId")}
                  className="w-full border border-border rounded-md px-3 py-2 text-sm bg-background text-secondary focus:outline-none focus:ring-2 focus:ring-primary">
                  {COACHES.map((c) => <option key={c.id} value={c.id}>{c.name}</option>)}
                </select>
              </div>
              <div>
                <label htmlFor="camp-duration" className="text-sm font-semibold text-secondary mb-1 block">Interview duration</label>
                <select id="camp-duration" value={form.durationMinutes} onChange={setNum("durationMinutes")}
                  className="w-full border border-border rounded-md px-3 py-2 text-sm bg-background text-secondary focus:outline-none focus:ring-2 focus:ring-primary">
            ...
            <div>
              <label htmlFor="camp-desc" className="text-sm font-semibold text-secondary mb-1 block">Job description (optional)</label>
              <textarea
                id="camp-desc"
