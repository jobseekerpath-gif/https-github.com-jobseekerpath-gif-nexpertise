      ...
      <Card className="w-full max-w-md shadow-lg">
        <CardContent className="pt-8 pb-8 px-8">
          ...
          <form onSubmit={(e) => void handleSubmit(e)} className="space-y-4">
            <div>
              <label htmlFor="b2b-email" className="text-sm font-semibold text-secondary mb-1 block">Company email</label>
              <Input
                id="b2b-email"
                type="email"
                value={email}
            ...
            <div>
              <label htmlFor="b2b-password" className="text-sm font-semibold text-secondary mb-1 block">Password</label>
              <Input
                id="b2b-password"
                type="password"
                value={password}
