      ...
      <Card className="w-full max-w-lg shadow-lg">
        <CardContent className="pt-8 pb-8 px-8">
          ...
          <form onSubmit={(e) => void handleSubmit(e)} className="space-y-4">
            <div>
              <label htmlFor="reg-name" className="text-sm font-semibold text-secondary mb-1 block">Company name *</label>
              <Input id="reg-name" value={form.name} onChange={set("name")} placeholder="Acme Corp" required />
            </div>
            <div>
              <label htmlFor="reg-email" className="text-sm font-semibold text-secondary mb-1 block">Company email *</label>
              <Input id="reg-email" type="email" value={form.email} onChange={set("email")} placeholder="hr@company.com" required />
            </div>

            <div className="grid grid-cols-2 gap-3">
              <div>
                <label htmlFor="reg-pass" className="text-sm font-semibold text-secondary mb-1 block">Password *</label>
                <Input id="reg-pass" type="password" value={form.password} onChange={set("password")} placeholder="Min 8 chars" required />
              </div>
              <div>
                <label htmlFor="reg-confirm" className="text-sm font-semibold text-secondary mb-1 block">Confirm *</label>
                <Input id="reg-confirm" type="password" value={form.confirm} onChange={set("confirm")} placeholder="Repeat password" required />
              </div>
            </div>

            <div className="grid grid-cols-2 gap-3">
              <div>
                <label htmlFor="reg-phone" className="text-sm font-semibold text-secondary mb-1 block">Phone</label>
                <Input id="reg-phone" value={form.phone} onChange={set("phone")} placeholder="+91 98765 43210" />
              </div>
              <div>
                <label htmlFor="reg-ind" className="text-sm font-semibold text-secondary mb-1 block">Industry</label>
                <select
                  id="reg-ind"
                  value={form.industry}
            ...
            <div>
              <label htmlFor="reg-web" className="text-sm font-semibold text-secondary mb-1 block">Website</label>
              <Input id="reg-web" value={form.website} onChange={set("website")} placeholder="https://company.com" />
            </div>
