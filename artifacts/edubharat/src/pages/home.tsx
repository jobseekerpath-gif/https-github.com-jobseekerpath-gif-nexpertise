...
export default function Home() {
  const heroBadge    = useContent("home.hero.badge",       "AI-powered career & development platform");
  const heroSubtitle = useContent("home.hero.subtitle",    "Nexo gives every job seeker and professional a personal AI mentor — for skill development, spoken English, mock interviews, and live career updates.");
